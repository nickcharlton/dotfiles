...
cwd="$HOME/dotfiles/tmux/tmux-powerline"
...
declare -A weather
weather+=(["script"]="$HOME/dotfiles/tmux/segments/weather.sh")
...
declare -A date_custom
date_custom+=(["script"]="$HOME/dotfiles/tmux/segments/date.sh")
date_custom+=(["foreground"]="colour136")
date_custom+=(["background"]="colour235")
date_custom+=(["separator"]="${separator_left_bold}")
register_segment "date_custom"
